...
func (r *complexResolver) Developer(ctx context.Context, obj *public_models.Complex) (*public_models.Developer, error) {
...
func (r *complexResolver) Images(ctx context.Context, obj *public_models.Complex) ([]*public_models.Image, error) {
...
func (r *complexResolver) Documents(ctx context.Context, obj *public_models.Complex) ([]*public_models.Document, error) {
...
func (r *complexResolver) ProjectDeclarations(ctx context.Context, obj *public_models.Complex) ([]*public_models.Document, error) {
...
func (r *queryResolver) Complexes(ctx context.Context, ids []string, start *int, limit *int, sort *public_models.Sort, search *string) (*public_models.ComplexConnection, error) {
	...
	var nodes []*public_models.Complex
	for _, v := range data {
		nodes = append(nodes, new(public_models.Complex).FromEntity(v))
	}

	return &public_models.ComplexConnection{
		TotalCount: total,
		Nodes:      nodes,
...
func (r *queryResolver) Complex(ctx context.Context, id string) (*public_models.Complex, error) {
...
// Complex returns public_gateway.ComplexResolver implementation.
func (r *Resolver) Complex() public_gateway.ComplexResolver { return &complexResolver{r} }
