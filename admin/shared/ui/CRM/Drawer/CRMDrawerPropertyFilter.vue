...
const isHot = ref<boolean | undefined>(props.isHot);
const isDeleted = ref<boolean | undefined>(props.isDeleted);
const withPhotos = ref<boolean | undefined>(props.withPhotos);

const minPrice = ref<number | undefined>(props.minPrice);
const maxPrice = ref<number | undefined>(props.maxPrice);
const minArea = ref<number | undefined>(props.minArea);
const maxArea = ref<number | undefined>(props.maxArea);
const minLandArea = ref<number | undefined>(props.minLandArea);
const maxLandArea = ref<number | undefined>(props.maxLandArea);
const minPricePerMeter = ref<number | undefined>(props.minPricePerMeter);
const maxPricePerMeter = ref<number | undefined>(props.maxPricePerMeter);
const minPricePerAr = ref<number | undefined>(props.minPricePerAr);
const maxPricePerAr = ref<number | undefined>(props.maxPricePerAr);
