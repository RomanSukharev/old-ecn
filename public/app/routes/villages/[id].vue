    ...
    <div class="max-w-[900px]">
      ...
      <div class="rounded-xl border border-gray-100 p-5 mt-7">
        <div class="flex justify-between">
          <div class="">
            <div class="text-3xl font-bold">КП "{{ village?.title }}"</div>
          </div>
      ...
      <div class="flex space-x-5 items-stretch mt-7">
        ...
        >
          ...
          <div class="text-sm">{{ village?.developer?.title || "-" }}</div>
        </div>
        ...
        >
          ...
          <div class="text-sm">
            {{
              village?.inCity ? "в черте города" : village?.cityDistance || "-"
            }}
          </div>
        </div>
        ...
        >
          ...
          <div v-if="village?.isReady" class="text-sm">
            сдан{{
      ...
      <!-- Nearby -->
      <div class="mt-20">
        <div class="text-2xl font-bold mb-1">Окрестности</div>
      ...
      <div class="mt-20">
        ...
        <div class="text-gray-400 mb-9 text-sm">{{ village?.address }}</div>
      ...
      <!-- Properties within village -->
      <div class="mt-20">
        <div class="text-2xl mb-9 font-bold">Объекты</div>
            ...
            <div class="">
              ...
              <div class="flex space-x-1 text-xs">
                <div
                  ...
                  :class="{
                    '!bg-gray-200':
                      filter.subType === PropertySubTypeEnum.HOUSE,
                  }"
      ...
      <div class="mt-20">
        ...
        <div class="text-gray-400 mb-9 text-sm">
          Обновлено {{ $dayjs(village?.updatedAt).format("DD.MM.YYYY HH:mm") }}
        </div>
      </div>
      ...
      <!-- Related -->
      <div class="mt-20">
        <div class="text-2xl font-bold mb-9">Похожие КП</div>
...
const { result } = useVillageQuery({
  id,
});
const village = computed(() => result.value?.village);
...
const breadcrumbs = computed(() => [
  ...
  {
    url: `/villages/${village.value?.id}`,
    title: village.value?.title || "",
  },
]);
