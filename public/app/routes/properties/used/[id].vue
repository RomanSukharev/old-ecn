    ...
    <div class="max-w-[900px]">
      ...
      <div class="flex space-x-5 items-stretch mt-7">
        ...
        <div
          class="grow rounded-xl border border-gray-100 px-4 py-3 text-center"
        >
          <div class="mb-1 text-gray-500 text-xs">комнатность</div>
      ...
      <!-- Description -->
      <div class="mt-20">
        <div class="text-2xl font-bold mb-9">О квартире</div>
      ...
      <!-- Blog -->
      <div v-if="property?.inComplex" class="mt-20">
        <div class="text-2xl font-bold mb-4">
          ЖК {{ property.complex?.title }}
        </div>

        <Swiper slides-per-view="auto" :space-between="20">
          <SwiperSlide
            v-for="image in property?.complex?.images"
            :key="image.id"
            class="!w-fit"
          >
            <img
...
const breadcrumbs = computed(() => [
  ...
  {
    url: `/properties/used/${property.value?.id}`,
