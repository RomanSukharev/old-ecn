<template>
  <div class="max-w-desktop grow mx-auto pb-[60px]">
    ...
    <div class="flex justify-between mt-7 mb-2">
      <div class="text-3xl font-bold">Загородная недвижимость</div>
    </div>
    ...
    <div class="flex space-x-5 mt-9 items-start">
      <div
        ...
        class="flex flex-col space-y-10 grow"
        :class="[showMap ? 'basis-1/2' : '']"
      >
        <ECNCardsPropertySuburban
...
const propType = "suburban";

const filter = reactive<PropertyFilter>({
  type: PropertyTypeEnum.SUBURBAN,
});
